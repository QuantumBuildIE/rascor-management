...
public class CreateProposalLineItemValidator : AbstractValidator<CreateProposalLineItemDto>
{
    public CreateProposalLineItemValidator()
    {
        RuleFor(x => x.ProposalSectionId)
            .NotEmpty()
            .WithMessage("Proposal section ID is required");
